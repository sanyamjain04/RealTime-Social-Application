...
const ContactInformation = () => {
  ...
  return (
    <div className="w-[300px] h-screen bg-slate-200 dark:bg-dark dark:text-white gap-2 flex flex-col">
      ...
      {/* Header */}
      <div className="p-2" style={{boxShadow: '0px 0px 5px rgba(0, 0, 0, 0.25)'}}>
        <div className="flex items-center gap-3 p-4">
          <div onClick={toggleContactInformation} className="cursor-pointer">
           <XCircle size={20} />
          </div>
      ...
      <div className="group flex flex-col flex-grow p-2 overflow-hidden ">
        <div className="flex flex-col gap-2 overflow-y-scroll scrollbarThin">
          ...
          <div className="flex flex-col justify-center gap-3 p-2">
            ...
            <p className="font-semibold text-sm">Hi there, I am using Chatsapp 🔥</p>
          </div>
          ...
          <div className="flex gap-2 items-center justify-evenly p-1">
            <button className="flex gap-2 bg-transparent text-blue-400 border-blue-400 p-2 items-center border-2 rounded-lg"> 
              <Prohibit />
              <p>Block</p>
            </button>
            <button className="flex gap-2 bg-transparent text-blue-400 border-blue-400 p-2 items-center border-2 rounded-lg"> 
